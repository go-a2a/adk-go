...
type LiveRequest struct {
	// Content is the message content for turn-by-turn model communication.
	Content *genai.Content

	// Blob is the binary data for realtime mode communication.
	Blob *genai.Blob

	// Close indicates whether this request signals queue termination.
	Close bool
}
