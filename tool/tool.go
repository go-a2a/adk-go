...
func NewBaseTool(name, description string, paramSchema model.ToolParameterSpec, executeFn func(ctx context.Context, args json.RawMessage) (string, error)) *BaseTool {
	return &BaseTool{
		name:                    name,
