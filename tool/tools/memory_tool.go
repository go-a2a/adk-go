...
func NewLoadMemoryTool(artifactService artifact.ArtifactService) *tool.BaseTool {
...
func NewSaveMemoryTool(artifactService artifact.ArtifactService) *tool.BaseTool {
	paramSchema := model.ToolParameterSpec{
		"type": "object",
		"properties": map[string]any{
			"key": map[string]any{
...
func NewLoadArtifactsTool(artifactService artifact.ArtifactService) *tool.BaseTool {
	paramSchema := model.ToolParameterSpec{
		"type": "object",
		"properties": map[string]any{
			"path": map[string]any{
