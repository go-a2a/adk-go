...
func RegisterStandardTools(registry *tool.ToolRegistry, artifactService artifact.ArtifactService) {
...
func RegisterAllTools(registry *tool.ToolRegistry, artifactService artifact.ArtifactService, agentRegistry AgentTransferRegistry, userChoiceHandler UserChoiceHandler) {
